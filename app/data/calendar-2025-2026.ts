    ...
    if (!isWeekend(current)) {
      ...
      if (special) {
        if (special.type === 'celebracion') {
          // Celebraciones: tienen cycleDay Y special, avanzan el ciclo
          result[dateKey] = {
            date: dateKey,
          ...
          // Festivos, recesos, vacaciones, semana santa, clausura: sin cycleDay, NO avanzan el ciclo
          result[dateKey] = {
            date: dateKey,
            special: special.type,
            label: special.label,
